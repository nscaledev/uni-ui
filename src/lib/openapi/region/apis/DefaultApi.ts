...
export interface ApiV2ServersServerIDSnapshotPostRequest {
    serverID: string;
...
export class DefaultApi extends runtime.BaseAPI {
    ...
    /**
     * Snapshot a server to create an image.
     */
    async apiV2ServersServerIDSnapshotPostRaw(requestParameters: ApiV2ServersServerIDSnapshotPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Image>> {
        if (requestParameters.serverID === null || requestParameters.serverID === undefined) {
            throw new runtime.RequiredError('serverID','Required parameter requestParameters.serverID was null or undefined when calling apiV2ServersServerIDSnapshotPost.');
        }
        ...
        const response = await this.request({
            path: `/api/v2/servers/{serverID}/snapshot`.replace(`{${"serverID"}}`, encodeURIComponent(String(requestParameters.serverID))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: SnapshotCreateToJSON(requestParameters.snapshotCreate),
        }, initOverrides);
     ...
     * Snapshot a server to create an image.
     */
    async apiV2ServersServerIDSnapshotPost(requestParameters: ApiV2ServersServerIDSnapshotPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Image> {
        const response = await this.apiV2ServersServerIDSnapshotPostRaw(requestParameters, initOverrides);
        return await response.value();
    }
